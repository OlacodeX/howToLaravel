    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
                <img src="{{ asset('image/403.png') }}" alt="404 page" class="mx-auto">
                <p class="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl dark:text-white">Not Allowed!</p>
                <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">You do not have permission to access this resource!</p>
