    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" class="pt-8">
            ...
            {{-- <div class="mt-6 flex">
                ...
                <input type="text" id="website-admin" class="flex-1 min-w-0 p-2.5 block mt-1 w-full bg-gray-50 rounded-none py-3 border-none shadow text-gray-900 text-sm" placeholder="github username" >
            </div>
            <div class="mt-6 flex">
                <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                ...
                <input type="text" id="website-admin" class="flex-1 min-w-0 p-2.5 block mt-1 w-full bg-gray-50 rounded-none py-3 border-none shadow text-gray-900 text-sm" placeholder="linkedin username" >
            </div>
            <div class="mt-6 flex">
                <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                ...
                <input type="text" id="website-admin" class="flex-1 min-w-0 p-2.5 block mt-1 w-full bg-gray-50 rounded-none py-3 border-none shadow text-gray-900 text-sm" placeholder="twitter username" >
            </div> --}}
            <div class="mt-6">
