...
<ul class="flex justify-between w-1">
    <!-- prev -->
    ...
    <div class="flex">
        ...
        <li class="mx-2 w-10 px-2 py-1 text-center rounded border shadow bg-purple-800 text-white cursor-pointer" wire:click="gotoPage({{$page}})">{{$page}}</li>
        @else
