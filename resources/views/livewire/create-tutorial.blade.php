...
<x-tutorial-form-card>
    ...
    <form wire:submit.prevent="addTutorial">
        ...
        <div class="mt-4" wire:ignore>
            <x-textarea id="body" wire:model.defer="body" name="body" class="block mt-1 w-full bg-gray-50 rounded-none border-none shadow text-gray-900 text-sm"></x-textarea>
        ...
        <div class="mt-4">
            ...
            <div class="flex items-center justify-center w-full">
                <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                    ...
                    <input class="hidden" type="file" id="dropzone-file" wire:model="image"/>
                </label>
            </div> 
