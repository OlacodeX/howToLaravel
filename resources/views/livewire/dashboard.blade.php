...
<div class="p-4 sm:ml-64 mt-24">
    <div class="mb-4">
        <div class=" px-8 py-4 rounded bg-white from-gray-700/50 via-transparent shadow-md h-auto dark:bg-gray-800">
            <h1 class="font-black leading-4 text-xl">Hi, {{ explode(" ",Auth::user()->name)[0] }}😁 </h1>
            <h4 class="text-lg font-semibold py-2">You have created a total of {{ count(Auth::user()->tutorials) }} tutorials on laravelLab.</h4>
            <p class="pb-4 pt-2">Now that you are here, what do you say about making another great tutorial?</p>
