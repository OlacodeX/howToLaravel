        ...
        {{-- <div class="comments">
            ...
            <form action="" method="post">
                <div class="flex flex-row">
                    ...
                    <input type="text" id="input-group-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 " placeholder="name@flowbite.com">
                    </div>
                    ...
                    <input type="text" id="website-admin" class="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 " placeholder="elonmusk">
                    </div>
                </div>
    ...
    <div class="px-4 mx-auto max-w-screen-xl">
        ...
        <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
            <article class="max-w-xs">
                ...
                <p class="mb-4 font-light text-gray-500">Over the past year, Volosoft has undergone many changes! After months of preparation.</p>
